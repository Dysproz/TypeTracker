...
def update_time(value):
    return callbacks.update_data_time_ranges(data, value)
...
@app.callback(
    ...
    [Input('time_slider', 'value'),
     Input('date-submit-button', 'n_clicks'),
     Input('refresh', 'n_clicks')])
def update_typing_timesteries_typing_speed(value, d_n_clicks, refresh_click):
...
@app.callback(
    ...
    [Input('time_slider', 'value'),
     Input('date-submit-button', 'n_clicks'),
     Input('refresh', 'n_clicks')])
def update_typing_timesteries_character_use(value, d_n_clicks, refresh_click):
